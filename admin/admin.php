  ...
  <body>
    ...
    <div id="admin-top-menu" align="center"><br /><br />
      Inicio -- 
        ...
        <a href="http://104.236.175.157/mampa/analytics/piwik/index.php?module=Widgetize&action=iframe&moduleToWidgetize=Dashboard&actionToWidgetize=index&idSite=1&period=week&date=yesterday" target="adminframe">Estadisticas</a>
    ...
    <div id="admin-body-loader" align="center">
      <iframe name="adminframe" width="1280px" height="620px" border="2" src="http://104.236.175.157/mampa/analytics/piwik/index.php?module=Widgetize&action=iframe&moduleToWidgetize=Dashboard&actionToWidgetize=index&idSite=1&period=week&date=yesterday"></iframe>
    </div>
